...
class Delivery extends OmsModel
{
     ...
     * @return bool
     */
    public function setStatus(int $status, bool $save = true): bool
    {
        $this->status = $status;
        $this->status_at = now();
    ...
    /**
     * Установить статус доставки у службы доставки
     * @param  int  $status
     * @param  bool  $save
     * @return bool
     */
    public function setStatusXmlId(int $status, bool $save = true): bool
    {
