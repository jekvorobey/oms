...
abstract class BasketService
{
    ...
    abstract public function findFreeUserBasket(int $type, int|string $customerId): Basket;

    abstract protected function createBasket(int $type, int|string $customerId): Basket;
}
