...
use Greensight\Marketing\MarketingLibServiceProvider;
use Greensight\Message\MessageLibServiceProvider;
use Greensight\Store\StoreLibServiceProvider;
...
return [
    ...
    */
    ...
    'providers' => [
        ...
        StoreLibServiceProvider::class,
        LogisticsLibServiceProvider::class,
        MarketingLibServiceProvider::class,
        CustomerLibServiceProvider::class,
        CmsLibServiceProvider::class,
